...
import com.xceptance.loadtest.api.util.SearchHelperOrdered;


public class TJmeterOrdered extends JMeterTestCase implements NonSiteRelatedTest
{
    private HashTree tree;
    private String scheme;
    private String jmeterVariable = "${%s}";

    public TJmeterOrdered()
    {
...
//        Optional<File> testPlan = DataFileProvider.dataFile("Test Plan.jmx");
    ...
    {
        SearchHelper<TransactionController> transactionSearch = new SearchHelper<TransactionController>(TransactionController.class);
        tree.traverse(transactionSearch);
        ...
        // mapping and casting accordingly to requested classes
        SearchHelperOrdered<HTTPSamplerProxy, HeaderManager> completeSearch = new SearchHelperOrdered<HTTPSamplerProxy, HeaderManager>(HTTPSamplerProxy.class, HeaderManager.class);
        tree.traverse(completeSearch);
        
        // TODO assertions !
        ArrayList<SearchClass<HTTPSamplerProxy, HeaderManager>> searchResults = (ArrayList<SearchClass<HTTPSamplerProxy, HeaderManager>>) completeSearch.getSearchResults();
